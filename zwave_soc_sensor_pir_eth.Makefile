...
PROJECTNAME = zwave_soc_sensor_pir_eth
ARM_GCC_DIR_WIN = 
ARM_GCC_DIR_OSX = $(USER_DIR)/.silabs/slt/installs/conan/p/gcc-a92619eca33962/p
ARM_GCC_DIR_LINUX = 
POST_BUILD_EXE_WIN = 
...
####################################################################
-include zwave_soc_sensor_pir_eth.project.mak
