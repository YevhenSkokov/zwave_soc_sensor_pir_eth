...
static const sl_cli_command_info_t cli_cmd__sleeping = \
  SL_CLI_COMMAND(cli_sleeping,
                 "Enable or disable sleeping",
                  "enable or disable" SL_CLI_UNIT_SEPARATOR,
...
static const sl_cli_command_info_t cli_cmd__motion_detected = \
  SL_CLI_COMMAND(cli_motion_detected,
                 "Emulate - motion detected",
...
const sl_cli_command_entry_t sl_cli_default_command_table[] = {
  ...
  { "sleeping", &cli_cmd__sleeping, false },
  { "battery_report", &cli_cmd__battery_report, false },
  { "motion_detected", &cli_cmd__motion_detected, false },
